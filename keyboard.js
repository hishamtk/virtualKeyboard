const Keyboard = {
  ...
  init() {
    ...
    // Automatically use keyboard for elements wht  .use-keyboard-input
  ...
  _triggerEvent(handlename) {
    if (typeof this.eventhandler[handlename] == "function") {
      this.eventhandler[handlename](this.properties.value);
    }
  },
  _toogleCapsLock() {
